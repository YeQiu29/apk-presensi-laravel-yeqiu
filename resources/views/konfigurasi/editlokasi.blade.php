<form action="/konfigurasi/lokasi/{{ $lokasi->id }}/update" method="POST">
    @csrf
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" name="nama_lokasi" class="form-control" placeholder="Nama Lokasi" value="{{ $lokasi->nama_lokasi }}" required>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" name="lokasi_kantor" class="form-control" placeholder="Latitude, Longitude" value="{{ $lokasi->lokasi_kantor }}" required>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" name="radius" class="form-control" placeholder="Radius (meter)" value="{{ $lokasi->radius }}" required>
            </div>
        </div>
    </div>
    <div class="row mt-2">
